    ...
    <>
      ...
      <CRow>
        <CCol xs={12} md={4}>
          <CCard className="mb-4">
            <CCardBody>
              <h5 className="card-title mb-0">Users by Gender</h5>
          ...
          <CTable bordered hover responsive>
            ...
            <CTableBody>
              {tableExample.map((user, index) => (
                <CTableRow key={index}>
                  <CTableDataCell>
                    <CAvatar src={user.avatar.src} status={user.avatar.status} />
                    <div>{user.user.name}</div>
                    <div className="small text-body-secondary">{user.user.registered}</div>
                  </CTableDataCell>
                  <CTableDataCell>
                    <CIcon icon={user.country.flag} className="me-1" />
                    {user.country.name}
                  </CTableDataCell>
                  <CTableDataCell>
                    <div>{user.usage.value}%</div>
                    <div className="small text-body-secondary">{user.usage.period}</div>
                  </CTableDataCell>
                  <CTableDataCell>
                    <CIcon icon={user.payment.icon} className="me-1" />
                    {user.payment.name}
                  </CTableDataCell>
                  <CTableDataCell>{user.activity}</CTableDataCell>
                </CTableRow>
              ))}
            </CTableBody>
          </CTable>
