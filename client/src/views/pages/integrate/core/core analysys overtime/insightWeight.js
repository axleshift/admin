          ...
          <CCol md={12}>
            <CCard className={cardStyle}>
              <CCardHeader className={headerStyle}>
                <div>
                <h3 className="mb-0">
                    <FontAwesomeIcon icon={faWeightHanging} className="me-2 text-success" /> 
                    Shipment Weight Insights
                  </h3>
                   <small className={isDarkMode ? "text-light-emphasis" : "text-body-secondary"}>Track and analyze your monthly weight distribution</small>
                </div>
                ...
                {loading && (
                  <div className="d-flex justify-content-center align-items-center" style={{ height: "300px" }}>
                    <div className="text-center">
                      ...
                      <p className={`mt-3 ${isDarkMode ? "text-light-emphasis" : "text-medium-emphasis"}`}>Loading weight data...</p>
                    </div>
                  </div>
                )}
                      ...
                      <CCol lg={4} md={6} className="mb-4">
                        <CCallout color="primary" className="h-100">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <div className={isDarkMode ? "text-light-emphasis small" : "text-medium-emphasis small"}>Total Weight</div>
                      ...
                      <CCol lg={4} md={6} className="mb-4">
                        <CCallout color="info" className="h-100">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              <div className={isDarkMode ? "text-light-emphasis small" : "text-medium-emphasis small"}>Average Monthly Weight</div>
