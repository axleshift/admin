import{a as c}from"./index-t--hEgTQ.js";const l="AIzaSyBlGfiToGE4_D_86kpLw_7QSzvaAySDASA",h="https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent",u=async e=>{try{const t={length:e.length,hasLowercase:/[a-z]/.test(e),hasUppercase:/[A-Z]/.test(e),hasNumbers:/\d/.test(e),hasSymbols:/[^A-Za-z0-9]/.test(e),patterns:{hasRepeatedChars:/(.)\1{2,}/.test(e),hasSequentialNumbers:/(?:012|123|234|345|456|567|678|789)/.test(e),hasKeyboardPatterns:/(?:qwer|asdf|zxcv|wasd)/i.test(e)}},s=`
