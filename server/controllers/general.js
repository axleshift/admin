...
export const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    // Always use the environment-specific URL
    ...
    // Create the transporter with more robust settings
    ...
    // Don't verify before every email - slows things down and can timeout
    // Instead, let's directly try to send the email

    const mailOptions = {
      from: `"Axleshift System" <${process.env.EMAIL_USER}>`, // Add a friendly name
      to: user.email,
      subject: "Reset Your Password - Axleshift Admin",
